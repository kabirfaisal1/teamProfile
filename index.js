...
const addManager = () => {
    ...
    .then(managerInput => {
        ...
        const manager = new managerConstructor (name, id, email, officeNumber);
...
const addEmployee = () => {
    ...
    .then(employeeData => {
        ...
        if (role === "Engineer") {
            employee = new engineerConstructor (name, id, email, github);

            console.log(employee);

        } else if (role === "Intern") {
            employee = new internConstructor (name, id, email, school);
